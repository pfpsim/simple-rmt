...
BaseVectorEntry::BaseVectorEntry(BitString iPrefix, int iLength, int iPrefixTablePtr, int iActionPtr) : mPrefix(iPrefix), mLength(iLength), mPrefixTablePtr(iPrefixTablePtr), mActionPtr(iActionPtr) {
