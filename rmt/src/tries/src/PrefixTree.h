...
template <class T>
PrefixTree<T>::PrefixTree(T iDefaultAction, int iDefaultActionSize) : mRoot(new UnibitNode<T>(iDefaultAction, iDefaultActionSize)), mDefaultAction(iDefaultAction), mDefaultActionSize(iDefaultActionSize) {
}
...
template <class T>
PrefixTree<T>::PrefixTree(const PrefixTree<T> &iTree) {}
