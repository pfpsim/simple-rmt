...
#ifndef __Trie_Data_Structure__BaseVectorEntry__
#define __Trie_Data_Structure__BaseVectorEntry__
...
public:
    // Constructors
    BaseVectorEntry();
    BaseVectorEntry(BitString iPrefix, int iLength, int iPrefixTablePtr, int iActionPtr = 0);
...
#endif /* defined(__Trie_Data_Structure__BaseVectorEntry__) */