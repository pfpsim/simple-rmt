...
#ifndef BEHAVIOURAL_TCAMSEARCHENGINE_H_
#define BEHAVIOURAL_TCAMSEARCHENGINE_H_
#include <vector>
#include <string>
#include "structural/TcamSearchEngineSIM.h"

class TcamSearchEngine: public TcamSearchEngineSIM {
 public:
  SC_HAS_PROCESS(TcamSearchEngine);
  /*Constructor*/
  explicit TcamSearchEngine(sc_module_name nm,
          pfp::core::PFPObject* parent = 0,
          std::string configfile = "");
  /*Destructor*/
  virtual ~TcamSearchEngine() = default;
 ...
 private:
  void TcamSearchEngine_PortServiceThread();
  void TcamSearchEngineThread(std::size_t thread_id);
  std::vector<sc_process_handle> ThreadHandles;
};

#endif  // BEHAVIOURAL_TCAMSEARCHENGINE_H_
