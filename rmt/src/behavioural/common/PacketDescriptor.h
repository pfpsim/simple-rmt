 ...
 * This class represents a packet descriptor and provides easy access to basic fields as well as the ability to manually add arbitrary fields
 */
...
class PacketDescriptor: public pfp::core::PacketBase {
  ...
  */
   ...
   * @param source_module        Module from which this PacketDescriptor was sent
   * @param destination_module    Module for which this PacketDescriptor is intended
   * @param destination_x_coord    X-Coordinate of the OCN router on which the destination module is located
   * @param destination_y_coord    Y-Coordinate of the OCN router on which the destination module is located
   */
