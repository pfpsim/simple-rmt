...
/*
template <typename T>
inline bool nb_can_gets(const sc_vector<PFPObject::tlm_fifo_in<T>>& input_ports)
{
  bool can_get = false;
...
/*
template <typename T>
inline sc_event_or_list multiport_data_written_event(const sc_vector<PFPObject::tlm_fifo_in<T>>& input_ports)
{
...
*/
template <typename T>
inline sc_event_or_list multiport_data_written_event(
